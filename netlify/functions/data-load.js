...
import { ALLOWED_KEYS } from './_shared/data-keys.js';
...
export const handler = async (event) => {
  ...
  try {
    ...
    // data-save와 동일한 키 화이트리스트 적용 — _shared/data-keys.js의 단일 진실 소스
    ...
    map._serverBuild = process.env.SERVER_BUILD || '2026-05-19-11';
