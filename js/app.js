...
const CLIENT_BUILD = '2026-05-04-4';
...
function saveDay(){
  ...
  // 🔭 디버깅: 어떤 input이 실제로 저장되고/스킵되었는지 콘솔에 기록 (silent failure 가시화)
  const _saveDbg = { saved: [], skippedEmpty: [], skippedInvalid: [], skippedDisabled: [] };
